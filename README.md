...
1.1 Download 
* [Sources](https://github.com/microsoft/Rundeck-DB-Resource-Model-Source-Plugin.git)
...
*    [resources/create_posgresql_sample_tables.sql]resources/create_postgresql_sample_tables.sql)
